...
def play_audio_process_with_tab_monitor(cmd, monitor_flightradar=False):
    ...
    tab_grace_period = 3.0  # Allow initial seconds for browser to finish opening tab
    ...
    while proc.poll() is None:
        ...
        if tab_open:
            ...
            # Tab was previously open during this trigger, but is now closed by the user
            ...
            # If after grace period no FlightRadar tab is open (e.g. user closed it immediately or browser failed)
        ...
        try:
            ...
            if HAS_EDGE_TTS and ("Neural" in target_voice or "en-GB" in target_voice):
                ...
                try:
                    ...
                    # If FlightRadar tab was closed during MP3 synthesis, abort immediately
